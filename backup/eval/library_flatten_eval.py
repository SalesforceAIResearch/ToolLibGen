...
if __name__ == "__main__":
   ...
   parser.add_argument("--tool_path", type=str, default="/export/home/data/phy_library_v1_extracted_tools.json")
   parser.add_argument("--tool_embedding_path", type=str, default="/export/home/data/phy_library_v1_extracted_tools_embedding.pkl")
   parser.add_argument("--save_path", type=str, default="/export/home/data/dev_flatten_library_v1.json")
