...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_data_path", type=str, default="/Users/murong.yue/Desktop/data/superGPQA_test_data_science.json")
    parser.add_argument("--tool_path", type=str, default="/Users/murong.yue/Desktop/data/collected_tools_info_sci_lib_new.json")
    parser.add_argument("--tool_embedding_path", type=str, default="/Users/murong.yue/Desktop/data/collected_tools_info_sci_lib_new.pkl")
