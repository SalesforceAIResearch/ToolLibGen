...
def Flatten_retriever_tool_eval(question_data, tool_path, tool_embedding_path, model_name):
    ...
    # Build shared retriever once to reuse FAISS index across threads/questions
    ...
    def fn(d):
        ...
        local_tool_manager = UnifiedDynamicToolManager(shared_retriever)
        # try:
        question = d["question"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_data_path", type=str, default="/Users/murong.yue/Desktop/data/dev_math_data.json")
    parser.add_argument("--tool_path", type=str, default="/Users/murong.yue/Desktop/data/math_103k_tools_saved_all_flattened.json")
    parser.add_argument("--tool_embedding_path", type=str, default="/Users/murong.yue/Desktop/data/math_103k_tools_saved_all_flattened.pkl")
    ...
    question_data = read_json("/Users/murong.yue/Desktop/log/eval_log_20250916_045727.json")
