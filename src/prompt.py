...
You are an expert in creating tools.
Below is the single worked example we have:
**Question:**
{question}
...
**YOUR TASK:**
For this question, write a general tool that can solve similar questions. Each tool must be an executable Python function designed to perform one atomic reasoning step.

**Output Format:**
Generate one or multiple general tools, use:
...
A weaker LLM used this SIB and the tools to answer the question:
----- TOOLS USING INFORMATION FROM SIB START -----
{weaker_llm_response}
----- TOOLS USING INFORMATION FROM SIB END -----
...
# --------------------------------------------------------------------------------------
# STAGE 3 (UPGRADED): Batch Generation & Review
# --------------------------------------------------------------------------------------
...
TAR_FINAL_ANSWER_PROMPT = """
You are a helpful assistant.
Here is the question:
{question}
Here is the cot answer from you:
{cot_answer}
Here is the tool-augmented answer from you:
{aug_answer}

Please analyze the case and give your final answer.
You need to consider if the tool is helpful and if the using of tool is correct, do not overly trust it. 
You should also think if you are certain about the final answer from CoT. Give your analysis and give your final answer. 
The final answer should be a letter (A, B, C, D, E, F, G, H, I, J) or a number, based on the question. 
"""
...
Here is the cot answer from you:
{cot_answer}
Here is another answer from you:
{cot_answer_2}
